...
class ImageBindModel(nn.Module):
    ...
    def _create_modality_postprocessors(self, out_embed_dim):
        ...
        modality_postprocessors[ModalityType.VISION] = nn.Sequential(
            Normalize(dim=-1),
...
def imagebind_huge(pretrained=False):
    ...
    if pretrained:
        if not os.path.exists("/home/zhua0420/checkpoints/imagebind_huge.pth"):
            print(
                "Downloading imagebind weights to .checkpoints/imagebind_huge.pth ..."
            )
            os.makedirs("/home/zhua0420/checkpoints", exist_ok=True)
            torch.hub.download_url_to_file(
                "https://dl.fbaipublicfiles.com/imagebind/imagebind_huge.pth",
                "/home/zhua0420/checkpoints/imagebind_huge.pth",
                progress=True,
            )

        model.load_state_dict(torch.load("/home/zhua0420/checkpoints/imagebind_huge.pth"))
